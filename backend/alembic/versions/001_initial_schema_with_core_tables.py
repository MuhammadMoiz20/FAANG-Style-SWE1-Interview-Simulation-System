...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('must_haves', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'),
        sa.Column('nice_to_haves', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'),
        sa.Column('core_competencies', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'),
        sa.Column('interview_style_bias', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='{}'),
    ...
    op.create_table(
        ...
        sa.Column('stages', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'),
        sa.Column('stage_progress', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='{}'),
    ...
    op.create_table(
        ...
        sa.Column('concerns', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='[]'),
        sa.Column('artifacts', postgresql.JSON(astext_type=sa.Text()), nullable=False, server_default='{}'),
